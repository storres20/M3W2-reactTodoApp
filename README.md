...
> This web application is a TODO APP. It lets you add your daily activities and check them when you finish it

**[React Todo App]** is online TODO app.
...
```sh
  cd my-folder
  git clone https://github.com/storres20/M3W2-reactTodoApp.git
```
...
Feel free to check the [issues page](https://github.com/storres20/M3W2-reactTodoApp/issues).
